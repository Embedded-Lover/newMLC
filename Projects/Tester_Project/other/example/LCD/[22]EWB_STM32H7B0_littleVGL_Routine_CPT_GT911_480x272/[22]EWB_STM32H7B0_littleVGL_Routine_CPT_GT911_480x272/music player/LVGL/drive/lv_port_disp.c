...
#define LVGL_Buf_Sizes  (LV_HOR_RES_MAX*100)


// Ë«¾Ö²¿»º³å  
static lv_color_t draw_buf_2_1[LVGL_Buf_Sizes]__attribute__((at(0x2407F800)));	  /*A buffer for 10 rows*/
static lv_color_t draw_buf_2_2[LVGL_Buf_Sizes]__attribute__((at(0x2407F800+LVGL_Buf_Sizes*sizeof(lv_color_t))));   /*An other buffer for 10 rows*/
...
//    /* Example for 2) */
   ...
   lv_disp_buf_init(&draw_buf_dsc_2, draw_buf_2_1, draw_buf_2_2, LVGL_Buf_Sizes);   /*Initialize the display buffer*/
