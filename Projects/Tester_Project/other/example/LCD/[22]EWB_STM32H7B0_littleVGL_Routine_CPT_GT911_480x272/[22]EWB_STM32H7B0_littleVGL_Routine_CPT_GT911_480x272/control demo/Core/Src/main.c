...
>>>>> Function description: 
	...
	* 2. Run the official routine lv_demo_benchmark, control demonstration 
...
// LCD_PWMinit(40); // Backlight pin PWM initialization, duty cycle 40%		 
	...
	lv_demo_widgets(); // Run the official routine lv_demo_widgets, control demonstration 
	...
	{ 
		...
		HAL_Delay(20 ); // GT911 touch screen scan interval cannot be less than 10ms, it is recommended to set it to 20ms 
	} 
...
{ 
  ...
  */ 
  ...
  /* Set the LTDC clock, here it is set to 10MHz, that is, the refresh rate At around 60 frames, too high or too low will cause flickering */ 
