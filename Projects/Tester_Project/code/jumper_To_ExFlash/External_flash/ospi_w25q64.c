...
{
    #define W25Qxx_NumByteToTest 30                   // length of test data, 32K
	...
	uint8_t W25Qxx_TestAddr = 0;
	OSPI_Status = OSPI_W25Qxx_Init();                 // Initialize OSPI and W25Q64

	////////////////////////////// Normal mode
	W25Qxx_WriteBuffer[10] = 0xaa;
	OSPI_W25Qxx_SectorErase(W25Qxx_TestAddr);
	OSPI_Status = OSPI_W25Qxx_WriteBuffer(W25Qxx_WriteBuffer, W25Qxx_TestAddr, W25Qxx_NumByteToTest);
	OSPI_Status = OSPI_W25Qxx_ReadBuffer(W25Qxx_ReadBuffer, W25Qxx_TestAddr, W25Qxx_NumByteToTest);
	//////////////////////////////
	HAL_Delay(2000);
	//////////////////////////////
	W25Qxx_WriteBuffer[20] = 0x55;
	OSPI_W25Qxx_SectorErase(W25Qxx_TestAddr);
	OSPI_Status = OSPI_W25Qxx_WriteBuffer(W25Qxx_WriteBuffer, W25Qxx_TestAddr, W25Qxx_NumByteToTest);
	OSPI_W25Qxx_MemoryMappedMode();
	memcpy(W25Qxx_ReadBuffer,(uint8_t *)W25Qxx_Mem_Addr+W25Qxx_TestAddr,W25Qxx_NumByteToTest);
	//////////////////////////////
	if((W25Qxx_WriteBuffer[10] == 0xaa) && (W25Qxx_WriteBuffer[20] == 0x55))
	{
        return 0;
	}
	else
