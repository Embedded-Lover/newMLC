...
#define AO_CS_Pin GPIO_PIN_9
#define AO_CS_GPIO_Port GPIOE
#define LED_BACK_LIGHT_Pin GPIO_PIN_15
#define LED_BACK_LIGHT_GPIO_Port GPIOD
...
#define DO_CS_Pin GPIO_PIN_0
#define DO_CS_GPIO_Port GPIOE
#define DI_CS_Pin GPIO_PIN_1
#define DI_CS_GPIO_Port GPIOE
